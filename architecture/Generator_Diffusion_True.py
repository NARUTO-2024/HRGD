...
class generator_diffusion_true(UNetModel):  # ControlledUnetModel 继承自 UNetModel  noisy：[10,:,128,128]  timestep:[10(batch_size)]  control= None, only_mid_control= False
